...
`;
    ...
    md.use(mermaidDiagram, { js_url: 'https://cdn.jsdelivr.net/npm/mermaid@10.6.1/dist/mermaid.min.js', theme: 'default', className: 'mermaid-diagram' });
    ...
    console.log('原始 mermaid 代码块数量:', (testMarkdown.match(/```mermaid/g) || []).length);
    console.log('转换后的容器数量:', (html.match(/mermaid-diagram-container/g) || []).length);
}
